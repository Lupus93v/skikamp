        ...
        <div className="about-vlasic">
            ...
            <div className="about-vlasic-pic-txt">
                ...
                <div className="about-vlasic-txt">
                    <p>Влашић је планински масив који доминира Средњом Босном, чији је највиши врх Паљеник на 1.943 метра надморске висине. Најпитомији и за туристе најинтересантнији дио Влашића је познат као Бабановац. Смјештен је на висини од 1.260 метара.</p>
                    <br /><p>Бабановац је у ствари окосница туристичког развоја, па је још седамдесетих година на овом дијелу изграђена 90 метара висока скакаоница на којој су се одржавала међународна такмичења у скосковима "Покал Влашић".</p>
